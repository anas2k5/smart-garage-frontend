            ...
            IconButton(
              ...
              onPressed: () async {
                final added = await Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) =>
                        AddMechanicScreen(garage: widget.garage),
                  ),
                );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _infoRow(
                Icons.access_time_filled_rounded, b.bookingTimeFormatted),
const Divider(height: 24, color: Colors.white10),

Row(
  crossAxisAlignment: CrossAxisAlignment.end,
  children: [
    Expanded(child: _buildActionButtons(b)),
    ...
    Column(
      ...
      children: [
        ...
        if (b.finalCost != null)
          _costInfo("Final Total", b.finalCost, brandGreen),
      ],
    ),
  ],
),
...
void _openAssignMechanicSheet(Booking booking) async {
  ...
  Widget _buildActionButtons(Booking b) {
    ...
    if (b.status == 'PENDING') {
      actions.add(_btn("Reject", Colors.redAccent,
      ...
      actions.add(_btn(
        ...
        b.mechanicName == null) {
      actions.add(_btn("Assign Mechanic", brandGreen,
          () => _openAssignMechanicSheet(b)));
    } else if (b.status == 'IN_PROGRESS' &&
        b.finalCost != null) {
      actions.add(_btn("Finalize Service", brandGreen,
          () => _updateStatus(b.id, 'COMPLETED')));
    }

    if (['IN_PROGRESS', 'COMPLETED', 'PAID']
        .contains(b.status)) {
      actions.add(_btn(
        "Job Card",
        Colors.white,
        () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => OwnerJobCardViewScreen(
                bookingId: b.id,
